...
[ ![Matplotlib 3.11.0 documentation - Home](../../_static/logo_light.svg)![Matplotlib 3.11.0 documentation - Home](../../_static/logo_dark.svg)](https://matplotlib.org/stable/)
...
Most methods will also parse a string-indexable object like a _dict_ , a [structured numpy array](https://numpy.org/doc/stable/user/basics.rec.html#structured-arrays), or a [`pandas.DataFrame`](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html#pandas.DataFrame "\(in pandas v3.0.3\)"). Matplotlib allows you to provide the `data` keyword argument and generate plots passing the strings corresponding to the _x_ and _y_ variables.
...
Built from v3.11.0-2-g0aea1c481f.   
