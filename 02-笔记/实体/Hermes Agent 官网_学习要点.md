...
- **涉及工具/技术**: Agent, Connect, Delegate, Desktop, Discord, Docker, Email, Experiment
...
- [原文](../01-收件箱/自动捕获/Hermes Agent 官网.md)
- [编译版本](../02-笔记/实体/Hermes Agent 官网.md)
