...
> 来源: 自动捕获
> 原文链接: https://hermes-agent.nousresearch.com/docs
> 抓取时间: 2026-06-09
...
[![Hermes Agent](/docs/img/logo.png)![Hermes Agent](/docs/img/logo.png)**Hermes Agent**](/docs/)[Docs](/docs/user-stories)[Skills](/docs/skills)[Download](https://hermes-agent.nousresearch.com/desktop)
...
[Get Started →](/docs/getting-started/installation)[Download Desktop](https://hermes-agent.nousresearch.com/desktop)[View on GitHub](https://github.com/NousResearch/hermes-agent)
...
Machine-readable entry points to this documentation:
  ...
  * **[`/llms-full.txt`](/docs/assets/files/llms-full-ca700f608dbbf1cb9f8e350c9991caa0.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
