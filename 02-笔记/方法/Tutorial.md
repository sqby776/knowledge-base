...
title: Tutorial
source: 自动捕获
url: https://openpyxl.readthedocs.io/en/latest/tutorial.html
date: 2026-06-09
status: compiled
type: article
category: 方法
...
> 来源: 自动捕获
> 原文链接: https://openpyxl.readthedocs.io/en/latest/tutorial.html
> 抓取时间: 2026-06-09
...
- * [openpyxl 3.1.4 documentation](index.html) »
...
source_url: https://openpyxl.readthedocs.io/en/latest/tutorial.html
---

# Tutorial

> 自动抓取自: [https://openpyxl.readthedocs.io/en/latest/tutorial.html](https://openpyxl.readthedocs.io/en/latest/tutorial.html)
...
There is support for the popular [lxml](http://lxml.de) library which will be used if it is installed. This is particular useful when creating large files.
