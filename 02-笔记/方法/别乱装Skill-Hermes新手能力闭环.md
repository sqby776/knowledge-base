...
- [x] plan Skill 是否已配置？
- [x] native-mcp 是否已配置 MCP 服务器？
- [x] github-pr-workflow 是否已启用？
- [x] systematic-debugging 是否已启用？
- [x] test-driven-development 是否已启用？
- [x] 搜索/研究类 Skill 是否齐全？（duckduckgo-search、arxiv、blogwatcher 等）
- [x] humanizer 是否已安装？
