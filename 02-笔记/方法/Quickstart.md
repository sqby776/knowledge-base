...
> 来源: 自动捕获
> 原文链接: https://python-docx.readthedocs.io/en/latest/user/quickstart.html
> 抓取时间: 2026-06-09
...
[`Run`](../api/text.html#docx.text.run.Run "docx.text.run.Run") objects have both a `.bold` and `.italic` property that allows you to set their value for a run:
...
Like paragraph styles, a character style must already be defined in the document you open with the `Document()` call (see [Understanding Styles](styles-understanding.html#understanding-styles)).
...
[Working with Documents](documents.html "next chapter")
