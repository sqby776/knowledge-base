---
title: Quickstart[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#quickstart "Permalink to this headline")
created: 2026-05-29
updated: 2026-05-29
tags: ["auto-capture", auto-compiled]
status: compiled
sources: [https://python-docx.readthedocs.io/en/latest/user/quickstart.html]
source_url: https://python-docx.readthedocs.io/en/latest/user/quickstart.html
confidence: medium
---

# Quickstart[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#quickstart "Permalink to this headline")

> 自动抓取自: [https://python-docx.readthedocs.io/en/latest/user/quickstart.html](https://python-docx.readthedocs.io/en/latest/user/quickstart.html)

### Navigation
  * [index](https://python-docx.readthedocs.io/en/latest/genindex.html "General Index")
  * [next](https://python-docx.readthedocs.io/en/latest/user/documents.html "Working with Documents") |
  * [previous](https://python-docx.readthedocs.io/en/latest/user/install.html "Installing") |
  * [python-docx 1.2.0 documentation](https://python-docx.readthedocs.io/en/latest/index.html) »


# Quickstart[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#quickstart "Permalink to this headline")
Getting started with `python-docx` is easy. Let’s walk through the basics.
## Opening a document[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#opening-a-document "Permalink to this headline")
...
## Adding a paragraph[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-paragraph "Permalink to this headline")
...
## Adding a heading[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-heading "Permalink to this headline")
...
## Adding a page break[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-page-break "Permalink to this headline")
...
## Adding a table[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-table "Permalink to this headline")
...
## Adding a picture[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-picture "Permalink to this headline")
...
This example uses a path, which loads the image file from the local filesystem. You can also use a _file-like object_ , essentially any object that acts like an open file. This might be handy if you’re retrieving your image from a database or over a network and don’t want to get the filesystem involved.
### Image size[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#image-size "Permalink to this headline")
...
You’re free to specify both width and height, but usually you wouldn’t want to. If you specify only one, `python-docx` uses it to calculate the properly scaled value of the other. This way the _aspect ratio_ is preserved and your picture doesn’t look stretched.
...
## Applying a paragraph style[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#applying-a-paragraph-style "Permalink to this headline")
...
## Applying bold and italic[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#applying-bold-and-italic "Permalink to this headline")
In order to understand how bold and italic work, you need to understand a little about what goes on inside a paragraph. The short version is this:
  1. A paragraph holds all the _block-level_ formatting, like indentation, line height, tabs, and so forth.
...
[`Run`](https://python-docx.readthedocs.io/en/latest/api/text.html#docx.text.run.Run "docx.text.run.Run") objects have both a `.bold` and `.italic` property that allows you to set their value for a run:
...
## Applying a character style[¶](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#applying-a-character-style "Permalink to this headline")
In addition to paragraph styles, which specify a group of paragraph-level settings, Word has _character styles_ which specify a group of run-level settings. In general you can think of a character style as specifying a font, including its typeface, size, color, bold, italic, etc.
Like paragraph styles, a character style must already be defined in the document you open with the `Document()` call (see [Understanding Styles](https://python-docx.readthedocs.io/en/latest/user/styles-understanding.html#understanding-styles)).
...
### [Table of Contents](https://python-docx.readthedocs.io/en/latest/index.html)
  * [Quickstart](https://python-docx.readthedocs.io/en/latest/user/quickstart.html)
    * [Opening a document](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#opening-a-document)
    * [Adding a paragraph](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-paragraph)
    * [Adding a heading](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-heading)
    * [Adding a page break](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-page-break)
    * [Adding a table](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-table)
    * [Adding a picture](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#adding-a-picture)
      * [Image size](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#image-size)
    * [Applying a paragraph style](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#applying-a-paragraph-style)
    * [Applying bold and italic](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#applying-bold-and-italic)
    * [Applying a character style](https://python-docx.readthedocs.io/en/latest/user/quickstart.html#applying-a-character-style)


#### Previous topic
[Installing](https://python-docx.readthedocs.io/en/latest/user/install.html "previous chapter")
#### Next topic
[Working with Documents](https://python-docx.readthedocs.io/en/latest/user/documents.html "next chapter")
### Useful Links
