...
Machine-readable entry points to this documentation:
  ...
  * **[`/llms-full.txt`](/docs/assets/files/llms-full-1602b96374536ae815a46439808cb03e.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
