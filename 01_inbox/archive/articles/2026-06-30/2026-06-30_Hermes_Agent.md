...
Machine-readable entry points to this documentation:
  ...
  * **[`/llms-full.txt`](/docs/assets/files/llms-full-7d9ac679546bfbcab576adbae2ab9e82.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
