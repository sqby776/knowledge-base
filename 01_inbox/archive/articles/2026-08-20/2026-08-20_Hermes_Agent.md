...
[![Hermes Agent](/docs/img/logo.png)![Hermes Agent](/docs/img/logo.png)**Hermes Agent**](/docs/)[Docs](/docs/user-stories)[Skills](/docs/skills)[Download](https://hermes-agent.nousresearch.com/)
...
Search
  ...
  * [Guides & Tutorials](/docs/guides/run-nemotron-3-ultra-free)
...
[Get Started →](/docs/getting-started/installation)[Explore Bot Mode](/docs/user-guide/bot-mode)[Download Desktop](https://hermes-agent.nousresearch.com/)[View on GitHub](https://github.com/NousResearch/hermes-agent)
...
🤖 **[Bot Mode](/docs/user-guide/bot-mode)**|  Named Bots with their own model, memory, skills, routines, and chats  
...
Machine-readable entry points to this documentation:
  ...
  * **[`/llms-full.txt`](/docs/assets/files/llms-full-495d5fd9a2724dd4c6154c5e1a4c9c01.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
